...
void c_colorpicker::render() {
	...
	g_Render->FilledRectGradient(pos.x + 1, pos.y + 1, size.x - 2, size.y - 2,
		clr, clr,
	...
	if (dialogue.open) {
		...
		g_Render->FilledRectGradient(pos.x + 15, pos.y + 15, size.x - 30, 105,
		...
		for (auto i = 0; i < 6; i++)
			g_Render->FilledRectGradient(pos.x + 15 + i * ((size.x - 30.f) / 6.f), pos.y + 130, (size.x - 30.f) / 6.f, 10.f,
		...
		g_Render->FilledRectGradient(pos.x + 15, pos.y + 145, size.x - 30.f, 10.f,
